...
use $savedir/exit2016_oopi1.dta, clear
merge 1:1 HHID PN using $savedir/exit2016_use.dta, nogen keepusing(hospital_nights nh_nights dr_visits qtile_* ///
ZN102 ZN118 ZN135 ZN152 ZN165 ZN176 ZN190 ZN320 ZN324)


//note--no lZNger ask whether pay all/some/nZNe, but still ask whether pay any, so can recZNstruct
gen ZN039_1=1 if ZN040_1>0 & ZN040_1<9997
replace ZN039_1=3 if ZN040_1==0
replace ZN039_1=ZN040_1-9990 if missing(ZN039_1)

gen ZN039_2=1 if ZN040_2>0 & ZN040_2<9997
replace ZN039_2=3 if ZN040_2==0
replace ZN039_2=ZN040_2-9990 if missing(ZN039_2)

gen ZN039_3=1 if ZN040_3>0 & ZN040_3<9997
replace ZN039_3=3 if ZN040_3==0
replace ZN039_3=ZN040_3-9990 if missing(ZN039_3)


scalar z = cpi2016 / cpiBASE							  

*if amount missing, expenses=ZES:
qui sum MC_HMO
replace MC_HMO = r(mean) if (MC_HMO == .) & (ZN009 == 1)

*if amount missing, expenses=NO:
replace MC_HMO = 0 if (MC_HMO == .) & (ZN009 == 5)

*if amount missing, expenses=DK/NA/RF:
qui sum MC_HMO
replace MC_HMO = r(mean) if (MC_HMO == .) & (ZN009 == 8 | ZN009 == 9)

*if missing, coverage=ZES, PrevDescrPlan=N0:
qui sum long_term_care
replace long_term_care = r(mean) if (long_term_care == .) & ///
							        (ZN071 == 1) & (ZN072 != 1)

*if missing, coverage=NO OR coverage=ZES and PrevDescrPlan==ZES:
replace long_term_care = 0 if (long_term_care == .) & ///
							  ((ZN071 == 5) | (ZN071 == 1 & ZN072 == 1))

*if missing, coverage=DK/NA/RF:
qui sum long_term_care
replace long_term_care = r(mean) if (long_term_care == .) & (ZN071 == 8 | ZN071 == 9)
...
*if sum missing, # plans known to be 0:									 
replace private_medigap = 0 if (private_medigap == .) & (ZN023 == 0)
...
predict x, xb
tab x qtile_hospital
replace hospital_OOP = z * x * hospital_nights if hospital_OOP == . & (ZN099==1 | ZA124==1) & !(ZN102==1 | ZN102==6)
drop x

*if overnight stay==ZES, amount missing, and expenses ARE NOT fully covered:
qui sum hospital_OOP
replace hospital_OOP = r(mean) if (hospital_OOP==.) & (ZN099==1 | ZA124==1) & ///
								  (ZN102==2 | ZN102==3 | ZN102==5)

*if overnight stay==ZES, amount missing, and expenses ARE fully covered:
replace hospital_OOP = 0 if (hospital_OOP==.) & (ZN099==1 | ZA124==1) & (ZN102==1)

*if overnight stay==ZES, amount missing, and coverage of expenses is DK/RF/NA, costs
*are unsettled (==7), or missing (interviewee should have been asked but was not):
qui sum hospital_OOP
replace hospital_OOP = r(mean) if (hospital_OOP==.) & (ZN099==1 | ZA124==1) & ///
								  (ZN102==7 | ZN102==8 | ZN102==9 | ZN102==.)

*if overnight stay==NO and amount missing
replace hospital_OOP = 0 if (hospital_OOP==.) & (ZN099==5 & ZA124!=1)

*if overnight stay is DK/NA/RF and amount missing:
qui sum hospital_OOP
replace hospital_OOP = r(mean) if (hospital_OOP==.) & ///
								  (ZN099==8 | ZN099==9) & (ZA124!=1)

*impute with nights spent in NH where possible if expenses were not fully covered
est restore NH
predict x, xb
tab x qtile_nh
replace NH_OOP = z * x * nh_nights if NH_OOP == . & (ZN114 == 1 | ZA028 == 1 | ZA124 == 2) & !(ZN118 == 1 | ZN118 == 6)
drop x
...
qui sum NH_OOP
replace NH_OOP = r(mean) if (NH_OOP==.) & ///
							(ZN114 == 1 | ZA028 == 1 | ZA124 == 2) & ///
							(ZN118 == 2 | ZN118 == 3 | ZN118 == 5) 

*if amount missing and insurance coverage complete:							 
replace NH_OOP = 0 if (NH_OOP == .) & (ZN118 == 1)
...
replace NH_OOP = r(mean) if (NH_OOP == .) & ///
							(ZN114 == 1 | ZA028 == 1 | ZA124 == 2) & ///
							(ZN118 == 7 | ZN118 == 8 | ZN118 == 9 | ZN118 == .)
					
*if amount missing and the following are true--did not stay overnight in NH, did not
*die in NH, did not live in NH before death:
replace NH_OOP = 0 if (NH_OOP == .) & (ZN114==5 & ZA028!=1 & ZA124!=2)
...
*if amount missing, expenditures = ZES, coverage=INCOMPLETE:
qui sum patient_OOP
replace patient_OOP = r(mean) if (patient_OOP == .) & ///
								 (ZN135==2 | ZN135==3 | ZN135==5)

*if amount missing, expenditures=ZES, coverage=COMPLETE:
replace patient_OOP = 0 if (patient_OOP == .) & (ZN135==1 | ZN135==6)
						   
*if amount missing, expenditures=ZES, coverage=DK/NA/RF/unsettled:
qui sum patient_OOP
replace patient_OOP = r(mean) if (patient_OOP == .) & ///
								 (ZN135==7 | ZN135==8 | ZN135==9)

*if amount missing, expenditures=ZES, coverage=missing:
qui sum patient_OOP
replace patient_OOP = r(mean) if (patient_OOP == .) & ///
								 (ZN134 == 1) & ///
								 (ZN135 == .)
...
*if amount missing, expenditures = NO:						          
replace patient_OOP = 0 if (patient_OOP == .) & (ZN134 == 5)

*if amount missing, expenditures = DK/NA/RF:
qui sum patient_OOP
replace patient_OOP = r(mean) if (patient_OOP == .) & (ZN134==8 | ZN134==9)

*impute using doctor visits if possible where expenses not fully covered
est restore doctor
predict x, xb
tab x qtile_doctor
replace doctor_OOP = z * x * dr_visits if doctor_OOP==. & (dr_visits > 0 & dr_visits < .) & !(ZN152 == 1 | ZN152 == 6)
drop x

*if amount missing, insurance coverage known/incomplete:
qui sum doctor_OOP
replace doctor_OOP = r(mean) if (doctor_OOP == .) & ///
								(ZN152 == 2 | ZN152 == 3 | ZN152 == 5)

*if amount missing, insurance coverage is complete:
replace doctor_OOP = 0 if (doctor_OOP == .) & (ZN152 == 1 | ZN152 == 6)

*if amount missing, extent of coverage is DK/NA/RF/unsettled:
qui sum doctor_OOP
replace doctor_OOP = r(mean) if (doctor_OOP == .) & ///
								(ZN152 == 7 | ZN152 == 8 | ZN152 == 9)
...
qui sum dental_OOP
replace dental_OOP = r(mean) if (dental_OOP == .) & ///
								 (ZN165==2 | ZN165==3 | ZN165==5)

*if amount missing, expenditures=ZES, coverage=COMPLETE:
replace dental_OOP = 0 if (dental_OOP == .) & (ZN165==1 | ZN165==6)
						   
*if amount missing, expenditures=ZES, coverage=DK/NA/RF/unsettled:
qui sum dental_OOP
replace dental_OOP = r(mean) if (dental_OOP == .) & ///
								 (ZN165==7 | ZN165==8 | ZN165==9)
...
*if amount missing, expenditures = NO:						          
replace dental_OOP = 0 if (dental_OOP == .) & (ZN164 == 5)

*if amount missing, expenditures = DK/NA/RF:
qui sum dental_OOP
replace dental_OOP = r(mean) if (dental_OOP == .) & (ZN164==8 | ZN164==9)
...
replace hospice_OOP = r(mean) if (hospice_OOP == .) & ///
								 (ZA124 == 4 | ZN320 == 1) & ///
								 (ZN324 == 2 | ZN324 == 3 | ZN324 == 5)

*if amount missing and insurance coverage complete (==1) or no charge (==6):
replace hospice_OOP = 0 if (hospice_OOP == .) & (ZN324 == 1 | ZN324 == 6)								 
...
replace hospice_OOP = r(mean) if (hospice_OOP == .) & ///
								 (ZA124 == 4 | ZN320 == 1) & ///
								 (ZN324 == 7 | ZN324 == 8 | ZN324 == 9 | ZN324 == .)

*if amount missing and neither died in hospice or was hospice patient:
replace hospice_OOP = 0 if (hospice_OOP == .) & (ZN320 == 5) & (ZA124 != 4)

*if amount missing, did not die in hospice, but unsure if hospice patient:
qui sum hospice_OOP
replace hospice_OOP = r(mean) if (hospice_OOP == .) & ///
								 (ZA124 != 4) & (ZN320 == 8 | ZN320 == 9)

*impute if missing, take drugs regularly, coverage is incomplete:
qui sum RX_OOP
replace RX_OOP = r(mean) if (RX_OOP == .) & ///
							(ZN175 == 1) & ///
							(ZN176 == 2 | ZN176 == 3 | ZN176 == 5)

*set to 0 if missing, coverage is complete (==1) OR no charge (==6):
replace RX_OOP = 0 if (RX_OOP == .) & (ZN176 == 1 | ZN176 == 6)

*impute if missing, take drugs regularly, coverage VNknown or not asked:
qui sum RX_OOP
replace RX_OOP = r(mean) if (RX_OOP == .) & ///
							(ZN175 == 1) & ///
							(ZN176 == 7 | ZN176 == 8 | ZN176 == 9 | ZN176 == .)

*set to 0 if don't take drugs regularly:							
replace RX_OOP = 0 if (RX_OOP == .) & (ZN175 == 5)

*impute if VNknown whether take drugs regularly:
qui sum RX_OOP
replace RX_OOP = r(mean) if (RX_OOP == .) & (ZN175 == 8 | ZN175 == 9)
								
*impute if expenses=ZES, coverage=INCOMPLETE:
qui sum home_OOP
replace home_OOP = r(mean) if (home_OOP == .) & ///
							  (ZN189 == 1) & ///
							  (ZN190 == 2 | ZN190 == 3 | ZN190 == 5)

*set to 0 if coverage=COMPLETE (==1) or no charge (==6):
replace home_OOP = 0 if (home_OOP == .) & (ZN190 == 1 | ZN190 == 6)

*impute if expenses=ZES, coverage=DK/NA/RF/unsettled/missing:
qui sum home_OOP
replace home_OOP = r(mean) if (home_OOP == .) & ///
							  (ZN189 == 1) & ///
							  (ZN190 == 7 | ZN190 == 8 | ZN190 == 9 | ZN190 == .)

*set to 0 if expenses=NO:
replace home_OOP = 0 if (home_OOP == .) & (ZN189 == 5)
...
*impute where expenses=ZES:
qui sum other_OOP
replace other_OOP = r(mean) if (other_OOP == .) & (ZN332 == 1)

*set to 0 where expenses=NO:							    
replace other_OOP = 0 if (other_OOP == .) & (ZN332 == 5)

*impute where expenses=DK/NA/RF:
qui sum other_OOP
replace other_OOP = r(mean) if (other_OOP == .) & (ZN332 == 8 | ZN332 == 9)

*if amount missing, expenditures = ZES:
qui sum home_modif_OOP
replace home_modif_OOP = r(mean) if (home_modif_OOP == .) & (ZN267 == 1)									

*if amount missing, expenditures = NO:						          
replace home_modif_OOP = 0 if (home_modif_OOP == .) & (ZN267 == 5)

*if amount missing, expenditures = DK/NA/RF:
qui sum home_modif_OOP
replace home_modif_OOP = r(mean) if (home_modif_OOP == .) & (ZN267 == 8 | ZN267 == 9)

*if amount missing, expenses=ZES, had to pay=ZES:							   
qui sum special_OOP
replace special_OOP = r(mean) if (special_OOP == .) & ///
							  (ZN202 == 1) & ///
							  (ZN203 == 1)
...
*if amount missing, had to pay=NO:							  							 							
replace special_OOP = 0 if (special_OOP == .) & (ZN203 == 5)

*if amount missing, expenses=ZES, had to pay=DK/NA/RF/missing:
qui sum special_OOP
replace special_OOP = r(mean) if (special_OOP == .) & ///
							  (ZN202 == 1) & ///
							  (ZN203 == 8 | ZN203 == 9 | ZN203 == .)

*if amount missing, expenses=NO:
replace special_OOP = 0 if (special_OOP == .) & (ZN202 == 5)
...
save $savedir/exit2016_oopi2.dta, replace							  
...
use $savedir/exit2016_oopi2.dta, clear
keep HHID PN year MC_HMO private_medigap_* long_term_care hospital_OOP NH_OOP doctor_OOP patient_OOP dental_OOP hospice_OOP RX_OOP home_OOP special_OOP ///
	other_OOP home_modif_OOP
save $savedir/tmp2016.dta, replace
