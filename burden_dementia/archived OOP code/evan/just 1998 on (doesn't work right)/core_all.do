...
/*note--11/30/17--adjusted so that only looks at core years 1998 onward*/
...
//used for 1994
//note--12/1/17--don't have 1994
egen x = rowtotal( hospital_OOP NH_OOP doctor_OOP),m
gen hospital_NH_doctor_OOP = x // if missing(hospital_NH_doctor_OOP)
...
cap rm $savedir/core1994_all.dta
cap rm $savedir/core1995_all.dta
cap rm $savedir/core1996_all.dta
cap rm $savedir/core1998_all.dta
cap rm $savedir/core2002_all.dta
cap rm $savedir/core2004_all.dta
cap rm $savedir/core2006_all.dta
cap rm $savedir/core2008_all.dta
cap rm $savedir/core2010_all.dta
cap rm $savedir/core2012_all.dta
cap rm $savedir/core2014_all.dta
