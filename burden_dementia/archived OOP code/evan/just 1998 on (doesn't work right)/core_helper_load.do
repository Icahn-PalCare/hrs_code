...
//note--12/1/17--setting to 98 onward
...
cap rm "$savedir/helper_core_2014.dta"
cap rm "$savedir/helper_core_2012.dta"
cap rm "$savedir/helper_core_2010.dta"
cap rm "$savedir/helper_core_2008.dta"
cap rm "$savedir/helper_core_2006.dta"
cap rm "$savedir/helper_core_2004.dta"
cap rm "$savedir/helper_core_2002.dta"
cap rm "$savedir/helper_core_2000.dta"
cap rm "$savedir/helper_core_1998.dta"
cap rm "$savedir/helper_core_1996.dta"
cap rm "$savedir/helper_core_1995.dta"
cap rm "$savedir/helper_core_1993.dta"
