...
//note-12/4/17--changed the below because don't have the vars from 1995, etc.
egen x = rowtotal( hospital_OOP NH_OOP ),m
gen hospital_NH_OOP = x //if missing(hospital_NH_OOP)
drop x

egen x = rowtotal( home_OOP special_OOP ),m
gen home_special_OOP = x //if missing(home_special_OOP)
drop x
...
cap rm $savedir/exit1995_all.dta
cap rm $savedir/exit1996_all.dta
cap rm $savedir/exit1998_all.dta
cap rm $savedir/exit2002_all.dta
cap rm $savedir/exit2004_all.dta
cap rm $savedir/exit2006_all.dta
cap rm $savedir/exit2008_all.dta
cap rm $savedir/exit2010_all.dta
cap rm $savedir/exit2012_all.dta
